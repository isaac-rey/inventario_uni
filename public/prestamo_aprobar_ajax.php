...
$accion_msg = "Aprobó y registró el Préstamo ID {$id} del Equipo ID {$equipo_id} a un {$tipo_usuario} ID {$id_usuario_prestamo}.";

// La función auditar() toma la ID del usuario logueado por defecto
auditar($accion_msg);
// --------------------------------------------------------------
