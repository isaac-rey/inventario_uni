  ...
  if ($ci === '') {
    ...
    if (!$user) {
      ...
      try {
        ...
        // Identificamos al usuario por su ID y CI.
        $user_desc = htmlspecialchars($user['nombre'] . ' (Estudiante CI: ' . $ci . ')');
        auditar("Solicitud de restablecimiento de contraseña de ESTUDIANTE. CI: {$ci}.", $user['id']);
